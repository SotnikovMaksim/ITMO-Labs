...
import HW5.Base (HiValue(HiValueNumber, HiValueFunction, HiValueBool, HiValueNull, HiValueString, HiValueList, HiValueBytes, HiValueDict))
import HW5.Base (HiExpr(HiExprValue, HiExprApply, HiExprDict))
...
import qualified HW5.Base

---------------------------
------ COMPATIBILITY ------
---------------------------

$(do mcls <- TH.lookupTypeName "HW5.Base.HiMonad"
     case mcls of
       Nothing -> return []
       Just cls -> do
